...
-- ==========================================================
-- ADVERTENCIA: ESTE BLOQUE ELIMINA COMPLETAMENTE EL ENTORNO
-- Ejecutar solo en entornos de desarrollo o pruebas.
-- ADVERTENCIA: Los comandos de "ALTER SESSION" SI O SI se deberan ejecutar antes del borrado.
-- ==========================================================

--DROP USER USR_DEV CASCADE;
--DROP USER USR_BACKEND CASCADE;
--DROP USER USR_REPORTING CASCADE;
--DROP USER USR_AUDITOR CASCADE;
--DROP USER USR_ADMIN CASCADE;
--DROP USER USR_CFG CASCADE;
--DROP USER USR_INTEGRACION CASCADE;

--DROP ROLE ROLE_APP_RW;
--DROP ROLE ROLE_REPORTING_RO;
--DROP ROLE ROLE_AUDITOR_RO;
--DROP ROLE ROLE_ADMIN_ALL;
